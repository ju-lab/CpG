            ...
            if input_split[j] == '.':
                ...
                for kk in input_split[j].split('|'):
                    if kk == input_gt_thousand:
                        individual_class[j-1853][c_index] += 1
                        break
...
output_file = file("figure1e_individual_thousand.txt","w")
